...
class Gui(Tk):
    def __init__(self):
        ...
        self.ambulance_image = PhotoImage(file="2-guis/4-images/1-loading/ambulance.gif")
        self.bike_image = PhotoImage(file="2-guis/4-images/1-loading/bike.gif")
        self.plane_image = PhotoImage(file="2-guis/4-images/1-loading/plane.gif")
